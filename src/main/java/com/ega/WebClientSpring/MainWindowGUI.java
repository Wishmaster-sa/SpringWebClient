...
public class MainWindowGUI extends javax.swing.JFrame {
   ...
   private final AppSettings appSettings;
    ...
    private void initComponents() {
        ...
        jButtonUpdatePersonInDB = new javax.swing.JButton();
        jButtonDeletePersonFromDB = new javax.swing.JButton();
        jButtonCheckPersona = new javax.swing.JButton();
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "Ім'я", "Призвище", "По батькові", "Дата народження", "Вік", "РНОКПП", "Паспорт", "УНЗР", "Перевірен", "Дата запита"
            }
        ) {
        ...
        jTabbedPane.addTab("Таблиця", null, jScrollPane2, "");

        jButtonGetData.setText("Отримати все");
        ...
        jButtonAddRow.setText("Нова строка");
        ...
        jButtonUpdatePersonInDB.setText("Оновити персону в БД");
        jButtonUpdatePersonInDB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonUpdatePersonInDBActionPerformed(evt);
            }
        });

        jButtonDeletePersonFromDB.setText("Видалити персону");
        jButtonDeletePersonFromDB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonDeletePersonFromDBActionPerformed(evt);
            }
        });

        jButtonCheckPersona.setText("Запит на перевірку");
        jButtonCheckPersona.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCheckPersonaActionPerformed(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonUpdatePersonInDB)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonDeletePersonFromDB)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jButtonCheckPersona)
...
// <editor-fold defaultstate="collapsed" desc="КОНТЕКСТНЕ МЕНЮ">                          
    ...
    private void UpdatePersonInDatabase(){
        ...
        String patronymic     = tblModel.getValueAt(selectedRow,3).toString();
        LocalDate birthDate    = getDateFromString(tblModel.getValueAt(selectedRow,4).toString());
        String rnokpp       = tblModel.getValueAt(selectedRow,6).toString();
        String pasport      = tblModel.getValueAt(selectedRow,7).toString();
        String unzr         = tblModel.getValueAt(selectedRow,8).toString();
...
// <editor-fold defaultstate="collapsed" desc="ІНТЕРФЕЙСНІ ФУНКЦІЇ">                          
    ...
    private void jButtonUpdatePersonInDBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdatePersonInDBActionPerformed
        UpdatePersonInDatabase();

    }//GEN-LAST:event_jButtonUpdatePersonInDBActionPerformed

    private void jButtonDeletePersonFromDBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeletePersonFromDBActionPerformed
        DeletePersonFromDataBase();
    }//GEN-LAST:event_jButtonDeletePersonFromDBActionPerformed

    private void jButtonCheckPersonaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCheckPersonaActionPerformed
        CheckPersona();
    }//GEN-LAST:event_jButtonCheckPersonaActionPerformed
//</editor-fold>
...
// <editor-fold defaultstate="collapsed" desc="ДОПОМОЖНІ ФУНКЦІЇ">                          
    ...
    private void AddIntoTable(JSONObject bodyJSON){
        Object rowData[] = { //bodyJSON.toString()
            ...
            bodyJSON.optInt("id",0),
            bodyJSON.optString("firstName",""),
            bodyJSON.optString("lastName",""),
            bodyJSON.optString("patronymic",""),
            bodyJSON.get("birthDate"),
            bodyJSON.optInt("age",0),
            bodyJSON.optString("rnokpp"),
            bodyJSON.optString("pasport"),
            bodyJSON.optString("unzr"),
...
//</editor-fold>
    ...
    private javax.swing.JButton jButtonCheckPersona;
    private javax.swing.JButton jButtonDeletePersonFromDB;
    private javax.swing.JButton jButtonExit;
    private javax.swing.JButton jButtonGetData;
    private javax.swing.JButton jButtonGo;
    private javax.swing.JButton jButtonUpdatePersonInDB;
