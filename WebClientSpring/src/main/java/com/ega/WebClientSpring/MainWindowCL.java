...
public class MainWindowCL {
    ...
    public void run(String[] args){
        ...
        while (isWorking){
            ...
            if(argbegin>0){
                arg = command.substring(argbegin+1);
                command = command.substring(0, argbegin);
            }
            command = command.toLowerCase();
            switch(command){
                case "help": DisplayCommands();break;
                case "startgui":StartGUI(); break;
                case "list":ShowAllPersons(); break;
                case "addpersona":AddPersonaIntoDatabase(); break;
                case "updatepersona":UpdatePersona(); break;
                case "findpersona":FindPersona(); break;
                case "checkpersona":CheckPersona(); break;
                case "checkuppersona":CheckPersona(); break;
                case "deletepersona":StartGUI(); break;
                case "exit": ExitProgramm();break;
                case "quit": ExitProgramm();break;
